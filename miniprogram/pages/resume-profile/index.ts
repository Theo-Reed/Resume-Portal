...
Page({
  ...
  refreshDisplayData() {
    ...
    this.setData({
      ...
      certificates: profile.certificates || profile.certificate || [],
      skills: profile.skills || profile.skill || [],
      workExperiences: profile.workExperiences || profile.workExperience || profile.work_experiences || [],
